    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-surface border border-border rounded-lg p-8 md:p-12 max-w-lg mx-4 text-center relative overflow-hidden"
        >
          {/* Decorative corners */}
          <div className="absolute top-0 left-0 w-20 h-20 opacity-10">
            <svg viewBox="0 0 100 100" fill="primary"><path d="M0,0 Q50,20 0,50 Q20,50 50,100 Q30,50 0,0 Z" /></svg>
          </div>
